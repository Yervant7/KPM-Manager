...
KPM-Manager, Magisk veya KernelSU benzeri ve her ikisinin de en iyi yönlerini birleştiren bir root çözümdür. Magisk'in `boot.img` aracılığıyla kullanışlı ve kolay kurulum yöntemini ve KernelSU'nun güçlü kernel yamalama yeteneklerini birleştirir.

## KPM-Manager ve Magisk arasındaki fark nedir?

- Magisk başlangıç sistemini kernel'in ramdisk'indeki bir yama ile değiştirirken; KPM-Manager kernel'i doğrudan yamalar.

## KPM-Manager vs KernelSU

- KernelSU, cihazınızın kernel'i için her zaman OEM tarafından sağlanmayan kaynak kodunu gerektirir. KPM-Manager yalnızca stok `boot.img` dosyanızla çalışır.
...
Daha fazla bilgi için bkz [KPM nasıl yazılır?](https://github.com/yervant7/KPM-Manager/blob/main/doc/module.md)

## KPM-Manager and KernelPatch arasındaki ilişki

KPM-Manager, KernelPatch'e dayalıdır; onun tüm yeteneklerini devralır ve onu daha da geliştirmiştir.
...
[KernelPatch hakkında daha fazlasını öğrenin](https://github.com/yervant7/KPM-Manager)
...
- Ayrıca KPM-Manager, ek SELinux desteği sağlamak için doğrudan magiskpolicy'yi kullanır.
