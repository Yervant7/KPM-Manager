...
KPM-Manager è una soluzione per il root simile a Magisk o KernelSU, ma offre funzionalità aggiuntive.

## KPM-Manager vs Magisk

- Magisk modifica l'init, mentre KPM-Manager patcha il kernel Linux.

## KPM-Manager vs KernelSU

- KernelSU richiede il codice sorgente del kernel, mentre per KPM-Manager è sufficiente solo il file boot.img.

## KPM-Manager vs Magisk, KerenlSU
...
[Come scrivere un KPM](https://github.com/yervant7/KPM-Manager/blob/main/doc/module.md)

## Relazione tra KPM-Manager e KernelPatch

KPM-Manager dipende da KernelPatch, eredita tutte le sue capacità ed è stato ampliato.
...
[Scopri di più su KernelPatch](https://github.com/yervant7/KPM-Manager)
...
- Inoltre, KPM-Manager utilizza direttamente magiskpolicy per fornire ulteriore supporto SELinux.  
