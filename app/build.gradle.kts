...
val kernelpatchVersion: String = rootProject.extra.get("kernelpatchVersion") as String
...
registerDownloadTask(
    ...
    srcUrl = "https://github.com/Yervant7/KernelPatch/releases/download/$kernelpatchVersion/kpimg-android-no-root",
...
registerDownloadTask(
    ...
    srcUrl = "https://github.com/Yervant7/KernelPatch/releases/download/$kernelpatchVersion/kptools-android",
