...
class KPMService : RootService() {
    override fun onBind(intent: Intent): IBinder {
        ...
        return object : IKPMService.Stub() {
            ...
            override fun nativeLoadKernelPatchModule(superKey: String, modulePath: String, args: String): Bundle {
                val res = Natives.nativeLoadKernelPatchModule(superKey, modulePath, args)
                return Bundle().apply {
                    putLong("rc", res.rc)
                    putString("msg", res.msg)
                }
            }
